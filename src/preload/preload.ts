...
const api: TETApi = {
  ...
  sbx: {
    ...
    checkNetworkGoverned: () => ipcRenderer.invoke("sbx:check-network-governed"),
  ...
  repository: {
    ...
    suggestCommitMessage: (projectId) => ipcRenderer.invoke("repo:suggest-commit-message", projectId),
