...
//      "./foo/bar.ts", "C:\Users\x\file.txt", "~/.claude/settings.json"
...
// In both shapes the extension must contain at least one letter, which keeps IPs
// (192.168.1.1) and semver (1.0.0) out. False positives are acceptable: the
// host-side existence check (see ipc.ts) is the real safety net.
