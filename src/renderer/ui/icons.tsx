...
/** Lucide's `landmark`, vendored the same way — sbx's policy governed by an organization. Tall, so
 *  the long-side cap: measured 20 by 22 (stroke included), extent 20.23, centered at (12, 12). */
