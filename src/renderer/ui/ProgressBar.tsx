 ...
 * `position: relative`. See "One progress indicator per pane" in AGENTS.md. Never a second one in
 * a pane: a new slow reason feeds the bar it has. A spinner in an icon's place is not one of these,
