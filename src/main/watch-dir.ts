 ...
 * absolute path (measured at >100 000 a second on a repository watcher, each one scheduling a
 * refresh), and on Linux as one event carrying its basename after which the watch is silently
