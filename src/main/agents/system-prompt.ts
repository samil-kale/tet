 ...
 * instructions, not repeated with every message. Claude Code and pi append it to their
 ...
 * text, 2026-09-16, win32 host and sbx 0.42.1 — Claude Code 2.1.273, pi 0.85.1:
