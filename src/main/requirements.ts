 ...
 * CLI, and one of the agents. Nothing is answered from memory here — the dialog this feeds offers
 * a re-check, and each one looks again for the managers' bin directories (`augmentAgentPath`); a
 * program installed into a folder this process cannot know of needs a restart, and the dialog
 * says so. The projects opened afterwards do take the answer given here (`isAgentInstalled`).
 */
